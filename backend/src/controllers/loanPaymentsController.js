...
exports.getUpcomingPayments = exports.getOverduePayments = exports.updateLoanPayment = exports.generateLoanPayments = exports.getLoanPayments = exports.recordLoanPayment = exports.generateMonthlyReport = void 0;
const client_1 = require("@prisma/client");
const catchAsync_1 = require("../utils/catchAsync");
const loanPaymentsPdfGenerator_1 = require("../utils/loanPaymentsPdfGenerator");
...
const generateMonthlyReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const payments = yield prisma.loan_payments.findMany({
            where: {
        ...
        const reportData = {
            ...
            payments: Object.values(paymentsBySale).map(salePayments => {
                var _a, _b;
                if (!((_a = salePayments === null || salePayments === void 0 ? void 0 : salePayments[0]) === null || _a === void 0 ? void 0 : _a.sales))
                    return null;
                ...
                const lastPaidDate = (_b = [...paidPayments]
                    .sort((a, b) => new Date(b.paid_date || 0).getTime() - new Date(a.paid_date || 0).getTime())[0]) === null || _b === void 0 ? void 0 : _b.paid_date;
                return {
            ...
            summary: {
                total_loans: Object.values(paymentsBySale)
                    .reduce((sum, payments) => { var _a; return sum + Number(((_a = payments[0].sales) === null || _a === void 0 ? void 0 : _a.loan_amount) || 0); }, 0),
        ...
        (0, loanPaymentsPdfGenerator_1.generateLoanPaymentsPDF)(res, reportData);
    }
    catch (err) {
...
exports.recordLoanPayment = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const payment = yield tx.loan_payments.updateMany({
            where: {
                sale_id,
        ...
        const allPayments = yield tx.loan_payments.findMany({
            where: { sale_id },
...
exports.getLoanPayments = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalPaid = payments.reduce((sum, payment) => sum + Number(payment.paid_amount || 0), 0);
    const remainingBalance = Number(sale.loan_amount || 0) - totalPaid;
...
exports.generateLoanPayments = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { saleId } = req.params;
    // Get the sale details
    const sale = yield prisma.sales.findUnique({
        where: { id: parseInt(saleId) }
    ...
    yield prisma.loan_payments.deleteMany({
        where: { sale_id: parseInt(saleId) }
    });
    ...
    yield prisma.$transaction(payments.map(payment => prisma.loan_payments.create({ data: payment })));
    res.json({ message: 'Payment schedule generated successfully' });
}));
// Update a specific payment
exports.updateLoanPayment = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { paymentId } = req.params;
    const { paid_amount, paid_date } = req.body;
    // Start transaction
    const result = yield prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        // Update the payment
        const payment = yield tx.loan_payments.update({
        ...
        const totalPaid = allPayments.reduce((sum, p) => sum + Number(p.paid_amount || 0), 0) + Number(paid_amount);
        const remainingBalance = Number(payment.sales.loan_amount || 0) - totalPaid;
        return Object.assign(Object.assign({}, payment), { total_paid: totalPaid, remaining_balance: remainingBalance, payment_status: allPaid ? 'completed' : 'ongoing' });
    }));
    res.json(result);
}));
// Get overdue payments
exports.getOverduePayments = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const payments = yield prisma.loan_payments.findMany({
        where: {
            due_date: {
                lt: new Date()
...
exports.getUpcomingPayments = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
