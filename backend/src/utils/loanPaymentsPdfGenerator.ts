...
export function generateLoanPaymentsPDF(res: Response, data: LoanReportData) {
  ...
  const columns = [
    ...
    { header: 'Total Loan', width: 100, align: 'right' as const, icon: '💰' },
    { header: 'Monthly Payment', width: 100, align: 'right' as const, icon: '📅' },
    { header: 'Amount Paid', width: 100, align: 'right' as const, icon: '✓' },
    { header: 'Balance', width: 100, align: 'right' as const, icon: '⚖️' },
    { header: 'Progress', width: 80, align: 'center' as const, icon: '📊' },
